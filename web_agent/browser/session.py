...
# It automatically sets CDP logs to the same level as browser logs
...
from web_agent.utils import _log_pretty_url, is_new_tab_page
...
class BrowserSession(BaseModel):
				...
				if self.browser_profile.use_cloud or self.browser_profile.cloud_browser_params is not None:
					...
					try:
						...
						raise CloudBrowserAuthError(
							'Authentication failed for cloud browser service. Set browser_API_KEY environment variable. You can also create an API key at https://cloud.browser.com/new-api-key'
						)
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from web_agent.browser.watchdogs.page_lifecycle_watchdog import PageLifecycleWatchdog
		from web_agent.browser.watchdogs.console_watchdog import ConsoleWatchdog
